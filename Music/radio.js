  ...
  module.exports = {
    name: "radio",
    aliases: ['ro'],
    description: "(ro)Play a Radiostation",
    cooldown: 3,
    ...
    let resultsEmbed = new Discord.MessageEmbed()
        ...
        .addFields(
          ...
          **5:  ** [\`${Radiostations[5-1].split(" ")[0]}\`](${Radiostations[5-1].split(" ")[1]})
          ` , inline: true}, { name: `***<a:emoji_36:823489894562791444> Standard Radio***`, value: `**6:  ** [\`${Radiostations[6-1].split(" ")[0]}\`](${Radiostations[6-1].split(" ")[1]})
  ...
  **34: ** [\`${Radiostations[34-1].split(" ")[0]}\`](${Radiostations[34-1].split(" ")[1]})`, inline: true },
  ...
  message.channel.send(new MessageEmbed().setColor("#FF0000")
  .setDescription(`**<:emoji_49:840801679330508841> Searching 🔍 \`${Radiostations[i-1].split(" ")[0]}\`**`));
  //mute yourself
