...
execute(message) {
    ...
    message.react("<a:emoji_91:882033133753597992>").catch(console.error);
    //get the queue
    ...
    queue.textChannel.send(
      new MessageEmbed().setColor("#FF0000").setAuthor(`${message.author.username} skipped the song.`, "https://cdn.discordapp.com/emojis/769915194444480542.png")
    ).catch(console.error);
  }
};
